...
const Register = () => {
  ...
  const getRegister = (e) => {
    ...
    if (gender === "") {
      setGenderError(true);
      setGenderErrorMsg("Please Enter your gender")
    }
    if (status == "") {
      setStatusError(true);
      setStatusErrorMsg("Placed or not")
    }
    else if (
      name != "" &&
      dept != "" &&
    ...
    <div className="container">
      ...
      <div className="content">
        ...
        <div className="clg-logo">
          ...
          />
          <label for="html" style={{ color: "black" }}>
            Male
          </label>
          <input
            type="radio"
            ...
            onChange={(e) => setGender(e.target.value)}
          />
          <label for="css" style={{ color: "black" }}>
            Female
          </label> */}
          <input type="text" value={gender} onChange={(e) => {
            if (e.target.value!==""){
              ...
              setGenderError(true);
              setGenderErrorMsg("Enter your gender");
            }
          ...
          className="input2" />
          <br />
          {genderError && (<span style={{color: "red", marginLeft: "100px"}}>{genderErrorMsg}</span>)}
          <br />
          <input
            type="text"
            value={Address}
          ...
          <br />
          {AddressError && (
            <span style={{ color: "red", marginLeft: "100px" }}>{AddressErrorMsg}</span>
          )}
          <br />
          <input
            type="text"
            ...
            onChange={(e) => {
              if (e.target.value != "") {
                ...
                setStatusError(true);
                setStatusErrorMsg("Enter your are plced or not");
              }
          ...
          />
          <br />
          {StatusError && <span style={{ color: "red", marginLeft: "100px" }}>{StatusErrorMsg}</span>}
          <br /> 
          <button
            className="reg-btn"
